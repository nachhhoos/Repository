...
namespace Visyde
{
    ...
    public class ChatSystem : MonoBehaviour, IChatClientListener
    {
        ...
        public bool HasChatAppID{
			get{
                return !string.IsNullOrEmpty(PhotonNetwork.PhotonServerSettings.ChatAppID);
            }
		}
        ...
        public void ConnectToChat(){
            if (HasChatAppID)
            {
                ...
                chatClient.Connect(PhotonNetwork.PhotonServerSettings.ChatAppID, Connector.instance.gameVersion, new Photon.Chat.AuthenticationValues(PhotonNetwork.playerName));
            }
        }
        ...
        public void OnStatusUpdate(string user, int status, bool gotMessage, object message)
	{
        ...
        {
            chatClient.Subscribe(new string[] { PhotonNetwork.room.Name }, 5); // subscribe to the chat channel once connected to the chat server
        }
